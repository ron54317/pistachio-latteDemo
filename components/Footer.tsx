...
export default function Footer() {
    return (
        <footer className="relative bg-black text-white border-t border-green-900/10 py-16 md:py-20 px-6 overflow-hidden text-center md:text-left">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-span-2 flex flex-col items-center md:items-start">
                        <h3 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 md:mb-6 bg-gradient-to-r from-white to-green-50/80 bg-clip-text text-transparent">
                            Pistachio Latte
                        </h3>
                        <p className="text-green-50/40 leading-relaxed max-w-md font-light text-sm md:text-base">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <h4 className="text-[10px] md:text-xs font-bold tracking-[0.2em] text-green-400 mb-4 md:mb-6 uppercase">
                            MENU
                        </h4>
                        <ul className="space-y-3 text-green-50/50 font-light text-sm md:text-base">
                ...
                {/* Bottom Bar */}
                <div className="pt-10 border-t border-green-900/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] md:text-sm text-green-50/30">
                    <div className="font-light">
                        © 2026 Pistachio Latte. All rights reserved.
                    </div>
                    <div className="flex gap-6 md:gap-8 font-light">
